...
ActiveRecord::Schema.define(version: 20161226223032) do
  ...
  add_index "tags_associations", ["post_id"], name: "index_tags_associations_on_post_id", using: :btree
  add_index "tags_associations", ["tag_id"], name: "index_tags_associations_on_tag_id", using: :btree
